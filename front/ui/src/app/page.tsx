  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      ...
      <div className="flex-1 flex flex-col items-start text-left space-y-6">
        <h1 className="text-4xl text-black">Por un Peru informado en miras a las elecciones 2026</h1>
        <p className="text-lg text-black">Aprende sobre los candidatos, sus propuestas y mas</p>
